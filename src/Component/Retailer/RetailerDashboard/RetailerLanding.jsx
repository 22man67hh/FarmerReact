...
const RetailerLanding = () => {
  ...
  return (
    <div>
      <h2 className='mb-5 font-bold text-xs sm:items-center sm:text-2xl bg-gray-100 border-r shadow ring ring-green-500 rounded p-4 text-center '>Welcome Back {user?.name},We have lots of work here</h2>
